...
<body>
  <?
	...
	print("
  <br>
    <h3>List of availible AIs in database.</h3>");
    ...
    //%u number, %s string
    print("<br>
      <b>Name </b>".$row["Name"]. ",<b>Author </b>".$row["Author"]);
      }

      print("<br>
        <h3>List of games played.</h3>");
        ...
        print("<br>
          <h3>List of games that require data.</h3>");
          ...
          print("<table style='width:250px' border='1'>
            ...
            print("<form action='index.php' method='post'>
              ...
              print("<tr>
                ...
                print("<td>
                  <input type='number' name='FoodScore".$i."'>
                </td>");
                print("<td>
                  <input type='number' name='GoldScore".$i."'>
                </td>");
                print("<td>
                  <input type='number' name='StoneScore".$i."'>
                </td>");
                print("<td>
                  <input type='number' name='WoodScore".$i."'>
                </td>");
                print("<td>
                  <input type='number' name='BuildersScore".$i."'>
                </td>");
	...
	print("
          ...
          for($i = 0; $i < 2; $i++)
		{
			...
			/*
			print("<br>
            Game ".$_POST['GameId'.$i]." score wast posted! For p".$_POST['PlayerId'.$i]);
            print("<br>
              Food p".$player." score wast posted! " . $_POST['FoodScore'.$i]);
              print("<br>
                Gold p".$player." score wast posted! " . $_POST['GoldScore'.$i]);
                print("<br>
                  Stone p".$player." score wast posted! " . $_POST['StoneScore'.$i]);
                  print("<br>
                    Builder p".$player." score wast posted! " . $_POST['BuildersScore'.$i]);
                    */
